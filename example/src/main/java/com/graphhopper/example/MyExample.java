...
public class MyExample {
	public static final String PBF = "C:\\Users\\charreti\\Downloads\\new-york-latest.osm.pbf";
	static GHPoint trainWest = new GHPoint(40.8285,  -72.9097);  //https://www.openstreetmap.org/search?whereami=1&query=40.8285%2C-72.9097#map=16/40.8285/-72.9097
	static GHPoint trainEast = new GHPoint(40.83238, -72.90115); //https://www.openstreetmap.org/search?whereami=1&query=40.83238%2C-72.90115#map=19/40.83238/-72.90115
	
    public static void main(String[] args) {
        String relDir = args.length == 1 ? args[0] : "";
        GraphHopper hopper = createGraphHopperInstance(PBF); //relDir + "core/files/andorra.osm.pbf");
        routing(hopper);
//        speedModeVersusFlexibleMode(hopper);
//        headingAndAlternativeRoute(hopper);
//        customizableRouting(PBF);
    ...
    public static void routing(GraphHopper hopper) {
        ...
        GHRequest req = new GHRequest(trainWest, trainEast)//42.508552, 1.532936, 42.507508, 1.528773).
    ...
    public static void customizableRouting(String ghLoc) {
        ...
        GHRequest req = new GHRequest().setProfile("car_custom")
        		.addPoint(trainWest).addPoint(trainEast);
